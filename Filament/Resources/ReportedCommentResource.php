...
use App\Filament\Resources\ReportedCommentResource\Pages;
...
{
    protected static ?string $model = ReportedComment::class;
        ...
        return $table
            ->columns([
                ...
                ToggleIconColumn::make('is_viewed')
                    ...
                    ->tooltip(fn (ReportedComment $record) => $record->is_viewed != 1 ? __('Not viewed') : __('Viewed'))
                    ->sortable(),
            ])->defaultSort('id', 'desc')
            ->filters([
                //
    ...
    public static function infolist(Infolist $infolist): Infolist
    {
        return $infolist
            ->schema([
                ...
                Components\Section::make(__('Comment'))
                    ->schema([
                        Components\TextEntry::make('comment.comment')
                            ->prose()
                            ->hiddenLabel(),
                    ]),
            ]);
    ...
    {
        return [
            'index' => Pages\ListReportedComments::route('/'),
        ];
    }
}
